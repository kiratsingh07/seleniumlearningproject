...
public class Irctcftrnewpage extends GenericWrappers {
	...
	public void entercnfrmpasswrd(String text) {
	...
	public void entersecanswer(String text) {
		enterById("secAnswer",text);
	}
	...
	public void clickonmaritialstatus() {
	...
	public void enterstreetno(String text) {
	...
	public void clickpostoffice() {
		clickById("postOffice");
	}
	public void selectpostoffcie(String text) {
	...
	public void entermobilenumber1(String text) {
